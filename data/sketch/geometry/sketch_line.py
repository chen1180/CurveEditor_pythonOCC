...
class Sketch_Line(Sketch_Geometry):
    ...
    def __init__(self):
        ...
        self.myGeometry2d: Geom2d_Line = None
    ...
    def Compute(self):
        ...
        dir2d = gp_Dir2d(gp_Vec2d(startPnt2d, endPnt2d))
        self.myGeometry2d = Geom2d_Line(startPnt2d, dir2d)
    ...
    def Recompute(self):
        ...
        endPnt2d = self.myPoints[1].GetGeometry2d().Pnt2d()
        dir2d = gp_Dir2d(gp_Vec2d(startPnt2d, endPnt2d))
        self.myGeometry2d.SetLocation(startPnt2d)
        self.myGeometry2d.SetDirection(dir2d)
